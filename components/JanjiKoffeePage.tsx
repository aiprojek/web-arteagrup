    ...
    const janjiKoffeeMenuData = [
        {
            ...
            variants: ['Americano', 'Espresso'],
        },
        {
            id: 'kopi-series',
            icon: <i className="bi bi-cup-hot text-2xl text-amber-300 w-8 text-center"></i>,
            title: 'Kopi Series',
            description: 'Kreasi kopi susu spesial untuk setiap selera.',
            variants: ['Spanish Latte', 'Butterscotch', 'Spesial Mix', 'Kapuccino', 'Vanilla', 'Tiramisu', 'Hazelnut', 'Brown Sugar'],
        },
        {
            id: 'non-kopi',
    ...
    return (
        <>
            ...
            <div className="space-y-6 text-stone-300">
                ...
                <div>
                    <h3 className="text-lg font-semibold text-white mb-4 border-b-2 border-stone-600 pb-2">Pesan Sekarang</h3>
                    <a href="https://wa.me/6281225879494?text=Bismillah" target="_blank" rel="noopener noreferrer" aria-label="Pesan Janji Koffee melalui WhatsApp" className="w-full text-center bg-green-500 hover:bg-green-600 text-white font-bold py-3 px-4 rounded-lg transition-colors duration-300 flex items-center justify-center">
